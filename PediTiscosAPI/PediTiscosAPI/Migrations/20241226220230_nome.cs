        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModoEntregaId1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Produtos_ModosEntrega_ModoEntregaId1",
                        column: x => x.ModoEntregaId1,
                        principalTable: "ModosEntrega",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "cliente_1", new DateTime(2024, 12, 26, 22, 2, 29, 218, DateTimeKind.Local).AddTicks(1012) });

            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "Id", "CategoriaId", "CategoriaId1", "Detalhe", "Disponivel", "EmStock", "Imagem", "MaisVendido", "ModoEntregaId", "ModoEntregaId1", "Nome", "Origem", "PedidoId", "Preco", "Promocao", "Titulo", "UrlImagem" },
                values: new object[,]
                {
                    { 1, 1, null, "Bolinho frito de bacalhau", true, 100m, null, true, null, null, "Bolinho de Bacalhau", null, null, 5.00m, false, "", "https://exemplo.com/imagem1.jpg" },
                    { 2, 2, null, "Bife grelhado com batatas", true, 50m, null, false, null, null, "Bife à Portuguesa", null, null, 15.50m, true, "", "https://exemplo.com/imagem2.jpg" },
                    { 3, 3, null, "Doce tradicional português", true, 200m, null, true, null, null, "Pastel de Nata", null, null, 2.50m, false, "", "https://exemplo.com/imagem3.jpg" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produtos_ModoEntregaId1",
                table: "Produtos",
                column: "ModoEntregaId1");
